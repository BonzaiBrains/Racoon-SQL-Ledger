...
-- Englische Texte f�r eigene Zwecke und um Refernz iRacoon-SQL-Ledgerer Dokumentation zu erleichtern.
...
--
-- A0
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('0000','ANLAGEVERM�GEN','H','A0','A','');
