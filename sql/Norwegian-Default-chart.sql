...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1210', 'Maskiner og anlegg under utf�relse', 'A','', 'A', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1270', 'Verkt�y mv.', 'A','', 'A', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1370', 'Fordringer p� eiere, styremedlemmer mv.', 'A','', 'A', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1380', 'Fordringer p� ansatte', 'A','', 'A', '');
insert into chart (accno,description,charttype,gifi_accno,category,link)
values ('1390', 'Andre langsiktige fordringer', 'A','', 'A', '');
insert into chart (accno,description,charttype,gifi_accno,category,link)
values ('14', 'Varer', 'H', '', 'A', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1400', 'R�varer og innkj�pte halvfabrikata', 'A','', 'A', 'IC');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1460', 'Innkj�pte varer for videresalg', 'A','', 'A', 'IC');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1480', 'Forskuddsbetaling til leverand�rer', 'A','', 'A', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1580', 'Avsetning tap p� fordringer', 'A','', 'A', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1720', 'Forskuddsbetalt l�nn', 'A','', 'A', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1750', 'P�l�pte leieinntekter', 'A','', 'A', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1760', 'P�l�pte renteinntekter', 'A','', 'A', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('1780', 'Krav p� innbetaling av selskapskapital', 'A','', 'A', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2200', 'Konvertible l�n', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2210', 'Obligsjonsl�n', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2220', 'Gjeld til kredittinstitusjoner', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2240', 'Pantel�n', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2260', 'Gjeld til selskap i samme konsern', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2270', 'Andre valutal�n', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('230', 'Kortsiktig gjeld', 'H', '', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2300', 'Konvertible l�n', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2320', 'Sertifikatl�n', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2340', 'Andre valutal�n', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2360', 'Byggel�n', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2380', 'Kassakreditt', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2400', 'Leverand�rgjeld', 'A','', 'L', 'AP');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2620', 'P�leggstrekk', 'A','', 'L', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2710', 'Utg�ende 24% mva', 'A','', 'L', 'AR_tax:IC_taxpart:IC_taxservice');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2715', 'Utg�ende 12% mva', 'A','', 'L', 'AR_tax:IC_taxpart:IC_taxservice');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2717', 'Beregnet avgift utlandet', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2720', 'Inng�ende 24% mva', 'A','', 'L', 'AP_tax:IC_taxpart:IC_taxservice');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2725', 'Inng�ende 12% mva', 'A','', 'L', 'AP_tax:IC_taxpart:IC_taxservice');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2750', 'Oppgj�rskonto merverdiavgift', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2770', 'P�l�pt arbeidsgiveravgift', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2780', 'Skyldig arbeidsgiveravgift', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2781', 'Arb.giv.avg. p�l. feriep.', 'A','', 'L', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2910', 'Skyldig l�nn', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2920', 'Skyldig feriepenger', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2930', 'Gjeld til ansatte og aksjon�rer', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2950', 'P�l�pte renter', 'A','', 'L', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('2960', 'P�l�pte kostn. og forskuddsbet. inskudd', 'A','', 'L', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('3099', 'Milj�avgift', 'A','', 'I', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('40', 'R�varer og halvfabrikata', 'H', '', 'I', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('4010', 'Innkj�p varer, avgiftspliktig 24% mva', 'A','', 'E', 'AP_amount:IC_cogs:IC_expense');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('4020', 'Innkj�p varer, avgiftspliktig 12% mva', 'A','', 'E', 'AP_amount:IC_cogs:IC_expense');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('4060', 'Innkj�psprisreduksjoner', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('4110', 'Innkj�p varer, avgiftsfritt', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('4180', 'Innkj�psprisreduksjoner', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('4310', 'Innkj�p av varer for videresalg, 24% mva', 'A','', 'E', 'AP_amount:IC_cogs:IC_expense');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('4320', 'Innkj�p av varer for videresalg, 12% mva', 'A','', 'E', 'AP_amount:IC_cogs:IC_expense');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('4360', 'Frakt, toll m.m. vedr. innkj�p av varer for videresalg', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('4370', 'Rabatter m.m. vedr. innkj�p av varer for videresalg', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('5', 'L�nnskostnader', 'H', '', 'I', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('5010', 'Faste l�nninger', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('5090', 'Periodiseringskonto l�nn', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('5190', 'P�l�pne feriepenger', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('5411', 'Arb.giv.avg. p�l. feriep.', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('5500', 'Andre kostnadsgodtgj�relser', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('6000', 'Avskrivning p� bygn. & annen fast eiend.', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('6010', 'Avskrivning p� transportmidler, maskiner', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('6020', 'Avskrivning p� immaterielle eiendeler', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('6320', 'Renovasjon, vann, avl�p mv.', 'A','', 'E', 'AP_amount');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('6570', 'Arbeidskl�r og verneutstyr', 'A','', 'E', 'AP_amount');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('6720', 'Honorar for �konomisk & juridisk bistand', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('6750', 'Honorar regnskapsf�rer', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('6840', 'Aviser, tidsskrifter, b�ker mv.', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('6860', 'M�ter, kurs, oppdatering mv.', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('7100', 'Bilgodtgj�relse, oppgavepliktig', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('7105', '�reavrunding', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('7700', 'Styre- og bedriftsforsamlingsm�ter', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('7820', 'Innkommet p� tidligere nedskrevne fordri', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('7830', 'Tap p� fordringer', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('7850', 'Tap pga. brannskade', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('7860', 'Tap p� kontrakter', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('7900', 'Beholdningsendring anlegg under utf�rels', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('8000', 'Inntekter p� investeringer i datterselskap', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('8100', 'Verdired. av markedsbas.finans. oml�ps.', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('8110', 'Nedskrivn. av andre finansielle oml�ps.', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('8160', 'Purregebyr. leverand�r', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('8800', '�rsresultat', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('8900', 'Overf�ringer fond for vurderingsforskjel', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('892', 'Utbytte', 'H', '', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('8920', 'Avsatt utbytte/renter p� grunnfondsbevis', 'A','', 'E', '');
...
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('8910', 'Overf�ringer felleseid andelskapital for', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('8940', 'Aksjon�rbidrag', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('8950', 'Fondsemisjon', 'A','', 'E', '');
insert into chart (accno,description,charttype,gifi_accno,category,link) values ('8960', 'Overf�ringer annen egenkapital', 'A','', 'E', '');
...
--
INSERT INTO defaults (fldname, fldvalue) VALUES ('inventory_accno_id', (SELECT id FROM chart WHERE accno = '1250'));
INSERT INTO defaults (fldname, fldvalue) VALUES ('income_accno_id', (SELECT id FROM chart WHERE accno = '3010'));
INSERT INTO defaults (fldname, fldvalue) VALUES ('expense_accno_id', (SELECT id FROM chart WHERE accno = '4010'));
INSERT INTO defaults (fldname, fldvalue) VALUES ('fxgain_accno_id', (SELECT id FROM chart WHERE accno = '8080'));
INSERT INTO defaults (fldname, fldvalue) VALUES ('fxloss_accno_id', (SELECT id FROM chart WHERE accno = '8180'));
INSERT INTO defaults (fldname, fldvalue) VALUES ('weightunit', 'kg');
INSERT INTO defaults (fldname, fldvalue) VALUES ('precision', '2');
--
INSERT INTO curr (rn, curr, prec) VALUES (1,'NOK',2);
