...
if (-f "$form->{path}/custom/arapprn.raku") {
      eval { require "$form->{path}/custom/arapprn.raku"; };
}
if (-f "$form->{path}/custom/$form->{login}/arapprn.raku") {
      eval { require "$form->{path}/custom/$form->{login}/arapprn.raku"; };
}
