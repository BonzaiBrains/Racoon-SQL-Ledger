...
# admin.raku is linked to this script
#
#######################################################################
...
@scripts = qw(login.raku admin.raku custom/login.raku custom/admin.raku);
...
if (-f "$userspath/nologin.LCK" && $script ne 'admin.raku') {
  print "Content-Type: text/html\n\n" if $ENV{HTTP_USER_AGENT};
